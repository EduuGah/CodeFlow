...
| Exercícios | 149 — 35 de código, 49 de prever saída, 32 de lacuna, 26 de múltipla escolha, 3 de ordenar passos, 2 de escrever o teste, 2 de encontrar o bug |
...
| Flashcards | 22 |
| Testes | 799 de unidade + 122 de navegador |
